...
<style scoped>
.business-panel{display:grid;gap:12px;padding:16px 20px;background:#fff}.business-panel :deep(.el-select),.business-panel :deep(.el-input-number){width:100%}.capability-config-card,.calculation-rule-card{border:1px solid #e5e5e5;border-radius:2px;background:#fff}.panel-section-heading{min-height:56px;display:flex;align-items:center;justify-content:space-between;gap:16px;padding:10px 14px;border-bottom:1px solid #e5e5e5;background:#fafafa}.panel-section-heading h4{margin:0;color:#262626;font-size:13px;font-weight:500}.panel-section-heading p{margin:2px 0 0;color:#8c8c8c;font-size:11px;line-height:17px}.panel-section-heading>span{color:#8c8c8c;font-size:10px}.capability-selector-row{display:grid;grid-template-columns:230px minmax(220px,320px);align-items:center;gap:24px;padding:14px}.field-description{display:grid;gap:3px}.field-description strong{color:#262626;font-size:12px;font-weight:500}.field-description span{color:#8c8c8c;font-size:10px;line-height:16px}.capability-selector-row :deep(.el-select){max-width:320px}.capability-parameter-form{display:grid}.parameter-form-row{display:grid;grid-template-columns:230px minmax(220px,320px);align-items:center;gap:24px;min-height:66px;padding:10px 14px;border-bottom:1px solid #f0f0f0;box-sizing:border-box;transition:background-color .15s ease}.parameter-form-row:last-child{border-bottom:0}.parameter-form-row:hover{background:#fafafa}.parameter-description{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:3px 8px;min-width:0}.parameter-description strong{overflow:hidden;color:#262626;font-size:12px;font-weight:500;text-overflow:ellipsis;white-space:nowrap}.parameter-description span{grid-column:1;color:#8c8c8c;font-size:10px;line-height:16px}.parameter-description :deep(.el-tag){grid-column:2;grid-row:1 / span 2}.parameter-control{width:100%;max-width:320px;min-width:0}.calculation-editor{padding:14px}.semantic-card{display:grid;gap:7px;padding:16px;border:1px solid #e5e5e5;border-radius:2px;background:#fafafa}.semantic-card strong{font-size:13px;font-weight:500}.semantic-card span{color:#595959;font-size:11px;line-height:1.7}.property-list{margin:0;border:1px solid #e5e5e5}.property-list>div{display:grid;grid-template-columns:150px 1fr;border-bottom:1px solid #e5e5e5}.property-list>div:last-child{border-bottom:0}.property-list dt,.property-list dd{margin:0;padding:11px 14px;font-size:11px;line-height:1.6}.property-list dt{background:#fafafa;color:#595959}.property-list dd{color:#262626}@media(max-width:760px){.capability-selector-row,.parameter-form-row{grid-template-columns:1fr;gap:8px}.parameter-description,.parameter-control,.capability-selector-row :deep(.el-select){max-width:none}}
