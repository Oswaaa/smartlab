<template>
  <section class="trigger-editor">
    <div class="editor-heading">
      ...
      <el-button v-if="editable" class="btn-aliyun" size="small" :disabled="!actions.length" @click="addTrigger">添加触发器</el-button>
    </div>
    <div v-for="(trigger, index) in triggers" :key="trigger._systemKey || index" class="trigger-card">
      <div class="trigger-head">
        ...
        <el-button v-if="canEditTrigger(trigger)" class="btn-aliyun-danger-link" link @click="removeTrigger(index)">删除</el-button>
      </div>
