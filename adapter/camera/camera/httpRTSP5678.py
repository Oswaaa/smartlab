...
class MultiPlugDetector:
    def __init__(self, model_path):
        ...
        self.Y_DIFF_THRESHOLDS = {
            0: {'front': 205, 'back': 175},   # Column 1 (leftmost)(从左往右数，210是第一个)
            1: {'front': 269, 'back': 218},   # Column 2
            2: {'front': 266, 'back': 216},   # Column 3
            3: {'front': 208, 'back': 181}    # Column 4 (rightmost)
        }
            ...
            def do_GET(self):
                if self.path == '/status':
                    ...
                    if status_data['all_inserted']:
                        ...
                        # 找出有问题的top编号（从1开始）
                        problem_numbers = [str(i+5) for i in status_data['problem_tops']]
